...
const speechCorrectionRules = [
  [/(^|,)(化|划|话)(?=(一个|一颗|一朵|一座|一条|一位|两|二|三|四|五|六|七|八|九|十|\d|太阳|云朵|山峰|人物|男生|女生|圆|星星|爱心|树|房子|花))/g, "$1画"],
  [/会制|汇制/g, "绘制"],
  [/生辰|生存|声称/g, "生成"],
  [/眼视|演试|掩饰|演是|演事/g, "演示"],
  [/带眼镜|带眼睛|戴眼睛/g, "戴眼镜"],
  ...
  [/新星|心星|行星/g, "星星"],
  [/爱新|爱型|心形/g, "爱心"],
  [/身分|身份|山风|山封|山蜂|山分|三峰/g, "山峰"],
  [/云多|云多多|云顿|云豆/g, "云朵"],
  [/泰阳|太羊|太阳穴/g, "太阳"],
  [/花多|花顿/g, "花朵"],
  [/房字|房资|房屋子/g, "房子"],
  [/([一二两三四五六七八九十\d]+)棵数/g, "$1棵树"],
  [/数木|树母|小数/g, "树木"],
  [/左上脚|左上叫|左上交|左上觉/g, "左上角"],
  [/右上脚|右上叫|右上交|右上觉/g, "右上角"],
  [/左下脚|左下叫|左下交|左下觉/g, "左下角"],
  [/右下脚|右下叫|右下交|右下觉/g, "右下角"],
  [/上访|上房|上放/g, "上方"],
  [/下发|下放|下饭/g, "下方"],
  [/座边|坐边|左面/g, "左边"],
  [/又边|右面/g, "右边"],
